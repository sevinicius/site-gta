...
// Objetivo 1- quando o usuario cliicar no botão de seleçãoo de plataformas deve abrir uma caixa com os botões de seleção de plataforma

// passo 1 -  pegar o botão de seleção de plataformas no JS pra poder verificar quando o usuario cliicar encima dele
